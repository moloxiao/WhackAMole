...
import com.poxiao.pay.whackamole.PAY;
import com.poxiao.pay.whackamole.GamePayCallback;
...
public class PayService {
	...
	public static void pay(final int payPoint,final int reviveNum){
		if(payPoint == 7 || payPoint == 8){
			final int tempPayPoint = 2;
