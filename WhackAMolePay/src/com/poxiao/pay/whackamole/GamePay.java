...
import com.poxiao.pay.whackamole.plugin.mm.SmsPayImpl;
import com.poxiao.pay.whackamole.plugin.sky.SkyPayImpl;
import com.poxiao.pay.whackamole.widget.MarkClickOkInterface;
import com.poxiao.pay.whackamole.widget.PayDialog;
									...
									activity.runOnUiThread(new Runnable(){
										...
										public void run() {
											...
											buffett.pay(activity, 
													WhackAMolePayInfo.getInstance().getOrderInfo(payPoint, "123456", orderId), new PayCallback() {
